...
class HistoryInput(Input):
    ...
    _MENU_MODES = ("MODEL_SELECT", "MODEL_ADD_SELECT", "MODEL_SELECT_VERSION", "TEMP_SELECT", "CONTEXT_SELECT", "SKILL_MENU", "PERMISSIONS_SELECT", "THEME_SELECT", "PLAN_APPROVE")
        ...
        if state.ui.mode in self._MENU_MODES:
            if event.key == "up":
                ...
                if state.ui.mode == "MODEL_SELECT_VERSION":
                    ...
                    self.app._navigate_context_menu(-1)
